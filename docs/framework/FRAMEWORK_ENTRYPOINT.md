...
2.  **Estado Limpo:** O arquivo [PROJECT_STATE.md](../history/PROJECT_STATE.md) esteja sincronizado com a branch ativa no Git.
...
*   **Histórico de Estado de Longo Prazo:** Atualizações de progresso consolidadas no [PROJECT_STATE.md](../history/PROJECT_STATE.md).
