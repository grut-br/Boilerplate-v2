...
| [FRAMEWORK_ENTRYPOINT.md](./FRAMEWORK_ENTRYPOINT.md) | Entrypoint | Inicialização da Engine. | Ponto de partida operacional único do ecossistema. |
| [ARCHITECTURE_FREEZE.md](../architecture/ARCHITECTURE_FREEZE.md) | Foundation | Alinhamento arquitetural macro. | Visão geral da arquitetura congelada. |
| [DEVELOPMENT_GUIDE.md](../guides/DEVELOPMENT_GUIDE.md) | Foundation | Alinhamento de filosofia de desenvolvimento. | Princípios de CDD e políticas de congelamento. |
| [DOCUMENTATION_GUIDELINES.md](../guides/DOCUMENTATION_GUIDELINES.md) | Foundation | Modificações lógicas ou de documentação. | Diretrizes de ownership e camadas lógicas. |
| [FRAMEWORK_INDEX.md](./FRAMEWORK_INDEX.md) | Foundation | Mapeamento de caminhos e contexto (Loader/Builder). | Este arquivo (Mapa de navegação). |
| [FRAMEWORK_ENGINE.md](./FRAMEWORK_ENGINE.md) | Foundation | Visão geral resumida dos módulos lógicos. | Motor Cognitivo central. |
| [FRAMEWORK_EXECUTION.md](./FRAMEWORK_EXECUTION.md) | Modules | Carregamento da Engine de Escrita. | Manual técnico do Prompt Assembly Pipeline. |
| [FRAMEWORK_TOOLCHAIN.md](./FRAMEWORK_TOOLCHAIN.md) | Modules | Validação local por terminal físico. | Manual técnico de ferramentas sintáticas locais. |
| [FRAMEWORK_RUNTIME.md](./FRAMEWORK_RUNTIME.md) | Modules | Execução de controle temporário e RAM. | Manual técnico de isolamento e reversões. |
| [FRAMEWORK_RESULT_PROCESSOR.md](./FRAMEWORK_RESULT_PROCESSOR.md) | Modules | Fechamento transacional e homologação. | Manual técnico de julgamento e arquivamento. |
| [CAPABILITY_CONTRACT.md](../architecture/CAPABILITY_CONTRACT.md) | Contracts | Criação ou validação de Capabilities. | Contrato padrão contendo regras de interface. |
...
| :--- | :--- | :--- | :--- | :--- |
| **Planning** | Operational (Validated) | Engine Core (Control Plane) | [always-read.md](../../.agents/rules/always-read.md), [DEVELOPMENT_GUIDE.md](../guides/DEVELOPMENT_GUIDE.md) | [work-unit-template-v3.md](../../.ai-workspace/templates/work-unit-template-v3.md) |
| **Documentation** | Operational (Validated) | Engine Core (Execution Engine) | [always-read.md](../../.agents/rules/always-read.md), [DOCUMENTATION_GUIDELINES.md](../guides/DOCUMENTATION_GUIDELINES.md) | Templates do workspace e especificações |
| **Analysis** | Plugin (Operational) | Engine Core (Execution Engine) | [always-read.md](../../.agents/rules/always-read.md), [DEVELOPMENT_GUIDE.md](../guides/DEVELOPMENT_GUIDE.md) | Relatórios estruturados e logs em markdown |
